    ...
    if(isset($_SESSION['id']) && !empty($_SESSION['id'])) {
        ...
        if($exibe_nivel['usuario'] != 'admin') {
          echo 'Acesso negado';
            ...
            if(!empty($id) && !empty($nome) && !empty($selecao) && !empty($posicao)) {
                $query_update = "UPDATE Jogadores SET nome = '$nome', posicao = '$posicao', selecao = '$selecao' WHERE id = ". $id;
                ...
                $_SESSION['msg'] = '<div class="alert alert-warning" role="alert">
                    <i class="bx bx-error-circle" ></i> Nenhum jogador foi selecionado. </div>';
            }
        }
