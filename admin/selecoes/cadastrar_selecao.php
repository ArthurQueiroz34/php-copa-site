...
<body>
  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <h2><i class="bi bi-file-earmark-plus"></i> ADMINISTRAÇÃO - CADASTRO DE SELEÇÃO</h2>
    ...
    <section id="contact" class="form_cadastro">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <form action="" method="post" role="form" id="cadSel" name="form2" class="form_cadastro shadow p-5 mb-6 bg-white rounde" enctype="multipart/form-data">
              <?php
              ...
              <div class="row">
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="pais" class="form-control" id="pais" placeholder="Nome..." required>
                </div>
                <div class="form-group mt-3">
              ...
              <div class="row">
                <div class="col-md-6 mb-3">
                  <div class="text-center">
                    <button type="submit" id="btn_enviar" class="btn btn-success btn_cadastrar"><i class="bi bi-plus-lg"></i> Adicionar seleção</button>
                  </div>
                </div>
                <div class="col-md-6 mb-3">
                  <div class="text-center">
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body text-success">
                A seleção foi cadastrada com sucesso.
              </div>
  ...
  <script type="text/javascript" language="javascript">
    $(document).ready(function() {
      ...
      $('#cadSel').on('submit', function(event){
        event.preventDefault();
		    if($('#pais').val() == "") {

			    $("#msg-error").html('<div class="alert alert-danger" role="alert"><i class="bi bi-x"></i> Preencha um país.</div>');
          $("#pais").addClass('erro_campo');		
		    }
        else if($('#sigla').val() == ""){

          $("#msg-error").html('<div class="alert alert-danger" role="alert"><i class="bi bi-x"></i> Selecione uma sigla.</div>');
          $("#sigla").addClass('erro_campo');		
        }
        else {

            //Receber os dados do formulário
            var dados = $("#cadSel").serialize();
            $.post("../../php/selecoes/insert-selecao.php", dados, function (retorna){
                if(retorna == 1){
                    console.log(retorna);
                    ...
                    $("#msg-error").html('<div class="alert alert-danger" role="alert"><i class="bi bi-x"></i> Erro ao cadastrar: '+ retorna +'</div>');
                }
            });
        }
	  });
