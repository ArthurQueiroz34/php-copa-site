  ...
  <?php include("header_path.php"); ?>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
          ...
          <h2><i class='bx bxs-cog'></i> PAINEL - ADMINISTRAÇÃO - JOGADORES</h2>
        </div>
    ...
    <div class="container-fluid">
        <div class="section-title">
			<h2>Jogadores</h2>
            <a href="jogadores/cadastrar_jogador.php" class="btn btn-outline-success btn-lg"><i class="bi bi-folder-plus"></i> Adicionar jogador</a>
            <a href="selecoes/cadastrar_selecao.php" class="btn btn-outline-success btn-lg"><i class="bi bi-folder-plus"></i> Adicionar seleção</a>
            <a href="posicoes/cadastrar_posicao.php" class="btn btn-outline-success btn-lg"><i class="bi bi-folder-plus"></i> Adicionar posição</a>
        </div>
        

        <!-- Busca -->
        <div class="container" data-aos="fade-up">
            <form action="jogadores/listar_jogadores.php" method="POST">
		...
		<script>
			...
			function listar_usuario(pagina, qnt_result_pg){
                    ...
                    $.post('jogadores/listar_jogadores.php', dados , function(retorna){
