...
<body>
  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <h2><i class="bi bi-pencil-square"></i> ADMINISTRAÇÃO - EDITAR POSIÇÃO</h2>
    ...
    <section id="contact" class="form_cadastro">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <form action="" method="post" role="form" id="attPos" name="form2" class="form_cadastro shadow p-5 mb-6 bg-white rounde" enctype="multipart/form-data">
              <?php
                ...
                $id = filter_input(INPUT_GET, 'idp', FILTER_SANITIZE_URL);
                $query = mysqli_query($conexao, "SELECT * FROM Posicoes WHERE id = ".$id);
              ...
              <div class="row">
                <div class="form-group col-lg-2">
                  <label for="id" class="form-label"><i class="bi bi-123"></i> ID da posição</label>
                  <input type="text" name="id" class="form-control" id="id" placeholder="Digite o ID..." value="<?=$id?>" readonly="readonly" required>
                </div>
                <div class="form-group mt-3">
                    <label for="posicao" class="form-label"><i class="bi bi-fonts"></i> Posição (sigla) </label>
                    <input type="text" name="posicao" class="form-control" id="posicao" placeholder="Posição..." maxlength="3" value="<?=$exibe['posicao']?>" required>
                </div>
              </div>
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Atualizar posição</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body text-success">
                A posição foi atualizada com sucesso.
              </div>
  ...
  <script type="text/javascript" language="javascript">
    $(document).ready(function() {
      ...
      $('#attPos').on('submit', function(event){
        event.preventDefault();
          ...
          $("#posicao").addClass('erro_campo');		
            ...
            var dados = $("#attPos").serialize();
            $.post("../../php/posicoes/update-posicao.php", dados, function (retorna){
                if(retorna == 1){
                    console.log(retorna);
