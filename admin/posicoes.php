  ...
  <?php include("header_path.php"); ?>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
          ...
          <h2><i class='bx bxs-cog'></i> PAINEL - ADMINISTRAÇÃO - POSIÇÕES</h2>
        </div>
    </section><!-- End Breadcrumbs -->
      
    <div class="container-fluid">
        <div class="section-title">
			<h2>Posições dos jogadores</h2>
        ...
        <div class="container" data-aos="fade-up">
            <form action="posicoes/listar_posicoes.php" method="POST">
		...
		<script>
			...
			function listar_usuario(pagina, qnt_result_pg){
                    ...
                    $.post('posicoes/listar_posicoes.php', dados , function(retorna){
