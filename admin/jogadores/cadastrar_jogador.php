...
<body>
  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <h2><i class="bi bi-file-earmark-plus"></i> ADMINISTRAÇÃO - CADASTRO DE JOGADOR</h2>
    ...
    <section id="contact" class="form_cadastro">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <form action="" method="post" role="form" id="cadJog" name="form2" class="form_cadastro shadow p-5 mb-6 bg-white rounde" enctype="multipart/form-data">
              <?php
              ...
              <div class="row">
                ...
                <div class="form-group mt-3">
                    ...
                    <select class="form-control form-select" name="posicao" id="posicao" required>
                      ...
                      <?php
                        $query = mysqli_query($conexao, "SELECT id, posicao FROM Posicoes");
                        while($exibe_posicao = mysqli_fetch_array($query)) {
                          echo '<option value="'.$exibe_posicao["id"].'">'.$exibe_posicao["posicao"].'</option>';    
                        }
                      ?>  
                    </select>
                </div>
                <div class="form-group mt-3">
                    ...
                    <select class="form-control form-select" name="selecao" id="selecao" required>
                      ...
                      <?php
                        $query = mysqli_query($conexao, "SELECT id, pais FROM Selecoes");
                        while($exibe_posicao = mysqli_fetch_array($query)) {
                          echo '<option value="'.$exibe_posicao["id"].'">'.$exibe_posicao["pais"].'</option>';    
                        }
                      ?>  
                    </select>
                </div>
              ...
              <div class="row">
                <div class="col-md-6 mb-3">
                  <div class="text-center">
                    <button type="submit" id="btn_enviar" class="btn btn-success btn_cadastrar"><i class="bi bi-plus-lg"></i> Adicionar jogador</button>
                  </div>
                </div>
                <div class="col-md-6 mb-3">
                  <div class="text-center">
  ...
  <script type="text/javascript" language="javascript">
    $(document).ready(function() {
      ...
      $('#cadJog').on('submit', function(event){
        event.preventDefault();
          ...
          $("#posicao").addClass('erro_campo');		
            ...
            var dados = $("#cadJog").serialize();
            $.post("../../php/jogadores/insert-jogador.php", dados, function (retorna){
                if(retorna == 1){
                    console.log(retorna);
                    ...
                    $("#msg-error").html('<div class="alert alert-danger" role="alert"><i class="bi bi-x"></i> Erro ao cadastrar o jogador: '+ retorna +'</div>');
                }
            });
        }
	  });
