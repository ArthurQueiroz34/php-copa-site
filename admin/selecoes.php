  ...
  <?php include("header_path.php"); ?>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
          ...
          <h2><i class='bx bxs-cog'></i> PAINEL - ADMINISTRAÇÃO - SELEÇÕES</h2>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="container" data-aos="fade-up">
            <form action="selecoes/listar_selecoes.php" method="POST">
		...
		<script>
			...
			function listar_usuario(pagina, qnt_result_pg){
                    ...
                    $.post('selecoes/listar_selecoes.php', dados , function(retorna){
